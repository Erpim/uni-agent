...
from examples.swe_agent_blackbox.sandbox import CommandResult, YRSandboxCommands, extract_upstream, rewrite_gateway_url
...
async def mini_swe_agent_runner(
    ...
    **kwargs,
    ...
    sandbox = await YRSandboxCommands.create(
